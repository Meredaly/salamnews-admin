<script setup lang="ts">
  ...
  const getPublished = async () => {
    try {
      ...
      tabs.value[0].count = data.count_name_ru + data.count_name_tm + data.count_name_en
  ...
  <main-box>
    <div class="articles">
      <div class="articles__head">
        <div class="articles__title _page-title">{{ t('news') }}</div>
      ...
      <div class="articles__list">
        <articles-horizontal :articles="news" @open="openNews" />
      </div>
