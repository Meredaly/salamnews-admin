<script setup lang="ts">
  ...
  import { TabRoutes } from '../types/workingEnvironment'
  ...
  const tabRoutes: TabRoutes = {
    whiteboard: '/tenders/working-environment/whiteboard',
    'wait-list': '/tenders/working-environment/wait-list',
    planned: '/tenders/working-environment/planned'
  }
